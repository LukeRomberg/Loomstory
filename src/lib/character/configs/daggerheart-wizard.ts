...
// Muted class palette tuned for the parchment surface. Hex values surfaced as
// arbitrary Tailwind border/text classes so the theme prop slots straight into
// existing `border-leather/40` fallbacks. Gradients kept for any legacy callers
// that still read them, though the parchment redesign no longer fills cards.
export const DAGGERHEART_CLASS_THEMES: Record<string, ClassTheme> = {
  Bard: {
    gradient: "from-[#763E8B]/30 via-[#763E8B]/15 to-[#763E8B]/30",
    borderColor: "border-[#763E8B]",
    textColor: "text-[#763E8B]",
    icon: Music,
    domains: ["Grace", "Codex"],
  },
  Druid: {
    gradient: "from-[#457A3A]/30 via-[#457A3A]/15 to-[#457A3A]/30",
    borderColor: "border-[#457A3A]",
    textColor: "text-[#457A3A]",
    icon: Leaf,
    domains: ["Sage", "Arcana"],
  },
  Guardian: {
    gradient: "from-[#425872]/30 via-[#425872]/15 to-[#425872]/30",
    borderColor: "border-[#425872]",
    textColor: "text-[#425872]",
    icon: Shield,
    domains: ["Valor", "Blade"],
  },
  Ranger: {
    gradient: "from-[#5B6D25]/30 via-[#5B6D25]/15 to-[#5B6D25]/30",
    borderColor: "border-[#5B6D25]",
    textColor: "text-[#5B6D25]",
    icon: TreePine,
    domains: ["Bone", "Sage"],
  },
  Rogue: {
    gradient: "from-[#4E324B]/30 via-[#4E324B]/15 to-[#4E324B]/30",
    borderColor: "border-[#4E324B]",
    textColor: "text-[#4E324B]",
    icon: Eye,
  ...
  Sorcerer: {
    gradient: "from-[#8E2D20]/30 via-[#8E2D20]/15 to-[#8E2D20]/30",
    borderColor: "border-[#8E2D20]",
    textColor: "text-[#8E2D20]",
    icon: Sparkles,
    domains: ["Arcana", "Midnight"],
  },
  Warrior: {
    gradient: "from-[#8E4618]/30 via-[#8E4618]/15 to-[#8E4618]/30",
    borderColor: "border-[#8E4618]",
    textColor: "text-[#8E4618]",
    icon: Sword,
    domains: ["Blade", "Bone"],
  },
  Wizard: {
    gradient: "from-[#353865]/30 via-[#353865]/15 to-[#353865]/30",
    borderColor: "border-[#353865]",
    textColor: "text-[#353865]",
    icon: BookOpen,
